...
public class JUnitTest {
	...
	public void testCountLetter(){
		TextNote tn = new TextNote("a");
		TextNote tn1 = new TextNote("aa");
		assertEquals("These textnote.countLetters() should return the same char", tn.countLetters(), tn1.countLetters(), 0.0);
